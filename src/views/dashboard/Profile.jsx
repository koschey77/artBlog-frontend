...
function Profile() {
  ...
  const fetchProfile = () => {
    axiosInstance.get(`user/profile/${userId}/`).then((res) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      // Добавляем изображение только если оно изменилось
      ...
      console.log('Updating profile with data:', {
        ...
        has_image: profileData.image instanceof File,
        about_length: profileData.about?.length,
        bio_length: profileData.bio?.length,
      })

      const updateRes = await axiosInstance.patch(`user/profile/${userId}/`, formData, {
        headers: {
                      ...
                      <div className="col-12">
                        ...
                        {loading ? (
                          <button className="btn btn-secondary" type="button" disabled>
                            Updating Profile... <i className="fas fa-spinner fa-spin"></i>
                          </button>
                        ) : (
